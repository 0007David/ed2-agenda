...
import negocio.clases.AccesoAleatorio;
...
public class FormAgenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuBar1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Agenda telefónica", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 14))); // NOI18N
...
//        System.out.println(listaDeContactos);
    ...
    private void BT2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT2ActionPerformed
        if (!arbol.esArbolVacio()) {
            ...
            JOptionPane.showMessageDialog(this, "Error mo hay datos para eliminar", "Error!!", JOptionPane.ERROR_MESSAGE);
        }
        ...
        if (valor == 0) {
            String dir = System.getProperties().getProperty("user.dir") + "\\src\\datos\\contacto.txt";
                try {
                    ...
                    System.out.println("hubo un super error");
                }
                System.exit(0);            
        }
